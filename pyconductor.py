...
def main_funct(mat):
    ...
    * Example:
    ...
    while True:
        try:
            freq = float(input("\nWhat frequency (in Hertz) is "
                               "the material operating at? "))
        except ValueError:
    ...
    if test == 0:
        ...
        print(
            ...
            f"is {round(up, 3)} meters per second with a wavelength of "
            f"{round(lam, 3)} meters.\n")
        input('Press Enter to continue... \n')
    elif test >= 100:
...
while True:
    print(
        ...
        "A dictionary of sample materials at sample values to test out has "
        "been pre-loaded. To see it, type 'help'.\nThis will also list any "
        "custom materials that you have added to the dictionary using 'add'; "
        "they will be added to the end of the dictionary.\n\nTo test your own "
        "custom material and values, enter 'add' to add it to the dictionary "
    ...
    if main_prompt == "help":
            ...
            if prompt1 in ("y", "yes"):
                while True:
                    ...
                    while True:
                        ...
                        if is_valid == "":
                            print("Please enter yes or no, or simply y/n")
                        else:
                            break
                ...
                print("\nPlease enter yes or no, or simply y/n\n")
        ...
        try:
            ...
            if main_prompt == "":
                print("\nYou did not specify a material or command.\n"
                      "Please use a valid material listed in the "
                      "'help' command, or use 'add' to add your own.\n")
            else:
